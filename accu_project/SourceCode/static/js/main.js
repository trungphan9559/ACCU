...
var brandBoxChart6 = new Chart($('#social-box-chart-6'), {
  type: 'line',
  data: {
    labels: brandBoxChartLabels,
    datasets: [{
      ...
      pointHoverBackgroundColor: '#fff',
      borderWidth: 2,
      data: [64, 50, 56, 21, 97, 50, 10]
    }]
  },
  options: brandBoxChartOptions
});

var brandBoxChart7 = new Chart($('#social-box-chart-7'), {
  type: 'line',
  data: {
    labels: brandBoxChartLabels,
    datasets: [{
      ...
      pointHoverBackgroundColor: '#fff',
      borderWidth: 2,
      data: [10, 150, 50, 30, 60, 50, 10]
    }]
  },
  options: brandBoxChartOptions
});

var brandBoxChart8 = new Chart($('#social-box-chart-8'), {
  type: 'line',
  data: {
    labels: brandBoxChartLabels,
    datasets: [{
